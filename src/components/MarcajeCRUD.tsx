...
function MarcajeCRUD() {
  ...
  const handleSeleccionarEmpleado = (
              ...
              datos.map((reg) => {
                ...
                return (
                  <TableRow key={reg.MAR_ID}>
                    <TableCell>
                      {reg.MAR_FECHA
                        ? new Date(reg.MAR_FECHA).toLocaleDateString()
                        : '--'}
                    </TableCell>

                    <TableCell>
                      {reg.MAR_ENTRADA
                        ? new Date(reg.MAR_ENTRADA).toLocaleTimeString()
                        : '--'}
                    </TableCell>

                    <TableCell>
                      {reg.MAR_SALIDA
                        ? new Date(reg.MAR_SALIDA).toLocaleTimeString()
                        : '--'}
                    </TableCell>
                      ...
                      {!diferencia.positiva ? (
                        ...
                        <Box>
                          <Tooltip title="Autorizar">
                            <IconButton
                              color="success"
                              onClick={() => handleAutorizar(reg.MAR_ID, 1)}
                            >
                              <CheckIcon />
                            </IconButton>
                          </Tooltip>
                          ...
                          <Tooltip title="Rechazar">
                            <IconButton
                              color="error"
                              onClick={() => handleAutorizar(reg.MAR_ID, 2)}
                            >
                              <CloseIcon />
                            </IconButton>
                          </Tooltip>
